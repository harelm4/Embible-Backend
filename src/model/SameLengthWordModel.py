...
def filter_predictions_by_size(modelResult:ModelResult,text:str):
    """
...
class SameLengthWordModel(StandardModel):
    ...
    def __init__(self,wordModel:StandardModel):
        """
    ...
    def predict(self,text):
        ...
        return filter_predictions_by_size(modelResult,text)
